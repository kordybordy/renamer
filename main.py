...
class RenamerGUI(QMainWindow):
    def __init__(self):
        ...
        for button in (self.btn_lang_pl, self.btn_lang_en):
        ...
        if pl_flag_path:
            ...
            self.btn_lang_pl.setText("PL")
            self.btn_lang_pl.setToolButtonStyle(Qt.ToolButtonStyle.ToolButtonTextOnly)
        if en_flag_path:
            self.btn_lang_en.setIcon(QIcon(en_flag_path))
            self.btn_lang_en.setIconSize(QSize(24, 16))
        else:
            self.btn_lang_en.setText("EN")
            self.btn_lang_en.setToolButtonStyle(Qt.ToolButtonStyle.ToolButtonTextOnly)
        ...
        self.controls_group = Card("RENAME SETTINGS")
        controls_layout = QVBoxLayout()
        controls_layout.setSpacing(12)
        controls_layout.setContentsMargins(12, 12, 12, 12)

        self.rename_safety_group = Card("RENAME SAFETY")
        ...
        self.ocr_group = Card("OCR SETTINGS")
        ocr_layout = QVBoxLayout()
        ocr_layout.setSpacing(6)
        ...
        self.char_limit_label = QLabel("Max characters:")
        char_col.addWidget(self.char_limit_label)
        ...
        self.ocr_dpi_label = QLabel("OCR DPI:")
        dpi_col.addWidget(self.ocr_dpi_label)
        ...
        self.ocr_pages_label = QLabel("Pages to scan:")
        pages_col.addWidget(self.ocr_pages_label)
        ...
        self.parallelism_label = QLabel("Parallelism:")
        turbo_col.addWidget(self.parallelism_label)
        ...
        controls_layout.addWidget(self.ai_group)

        self.order_group = Card("NAME ORDER")
        order_layout = QVBoxLayout()
        order_layout.setSpacing(6)
        self.party_order_label = QLabel("Party order:")
        order_layout.addWidget(self.party_order_label)
        ...
        controls_layout.addWidget(self.order_group)

        self.controls_group.setLayout(controls_layout)
        rename_settings_layout.addWidget(self.controls_group)

        self.template_group = Card("FILENAME TEMPLATE")
        ...
        self.add_element_label = QLabel("Add element:")
        selector_col.addWidget(self.add_element_label)
        ...
        rename_settings_layout.addWidget(self.template_group)

        self.distribution_group = Card("DISTRIBUTION SETTINGS")
        ...
        self.auto_threshold_label = QLabel("Auto threshold (score):")
        auto_threshold_col.addWidget(self.auto_threshold_label)
        ...
        self.gap_threshold_label = QLabel("Gap threshold (score):")
        gap_threshold_col.addWidget(self.gap_threshold_label)
        ...
        self.ai_confidence_label = QLabel("AI confidence threshold:")
        ai_threshold_col.addWidget(self.ai_confidence_label)
        ...
        self.topk_label = QLabel("Top-K candidates:")
        topk_col.addWidget(self.topk_label)
        ...
        self.unmatched_label = QLabel("Handle UNMATCHED files:")
        unmatched_col.addWidget(self.unmatched_label)
        ...
        self.dest_exists_label = QLabel("If destination exists:")
        dest_exists_col.addWidget(self.dest_exists_label)
        ...
        self.stopwords_label = QLabel("Stopwords (comma-separated):")
        stopwords_col.addWidget(self.stopwords_label)
        ...
        distribution_settings_layout.addWidget(self.distribution_group)

        self.mode_group = Card("MODE")
        ...
        mode_row.addStretch()
        self.mode_group.setLayout(mode_row)
        distribution_settings_layout.addWidget(self.mode_group)

        self.unresolved_group = Card("UNRESOLVED HANDLING")
        ...
        self.unresolved_scope_label = QLabel("Create folder for:")
        unresolved_scope_row.addWidget(self.unresolved_scope_label)
        ...
        self.unresolved_group.setLayout(unresolved_layout)
        distribution_settings_layout.addWidget(self.unresolved_group)
        ...
        self.dist_paths_group = Card("DISTRIBUTION PATHS")
        ...
        self.distribution_input_label = QLabel("Folder containing PDFs to distribute:")
        dist_input_col.addWidget(self.distribution_input_label)
        ...
        self.case_root_label = QLabel("Case folders root:")
        dist_cases_col.addWidget(self.case_root_label)
        ...
        self.dist_paths_group.setLayout(dist_frame_layout)
        self.distribution_layout.addWidget(self.dist_paths_group)


        self.dist_controls_group = Card("EXECUTION")
        ...
        self.dist_controls_group.setLayout(dist_controls)
        self.distribution_layout.addWidget(self.dist_controls_group)

        self.plan_group = Card("DISTRIBUTION PLAN")
        ...
        self.plan_show_label = QLabel("Show:")
        plan_controls.addWidget(self.plan_show_label)
        ...
        self.plan_sort_label = QLabel("Sort:")
        plan_controls.addWidget(self.plan_sort_label)
        ...
        self.distribution_layout.addWidget(self.plan_group)
    ...
    def retranslate_ui(self):
        ...
        if hasattr(self, "controls_group"):
            ...
            self.char_limit_label.setText(self.tr("Max characters:"))
            self.ocr_dpi_label.setText(self.tr("OCR DPI:"))
            self.ocr_pages_label.setText(self.tr("Pages to scan:"))
            self.ai_group.set_title(self.tr("AI ENGINE"))
            self.engine_label.setText(self.tr("Engine:"))
            self.parallelism_label.setText(self.tr("Parallelism:"))
            self.turbo_mode_checkbox.setText(self.tr("Turbo mode (parallel AI queries)"))
            self.turbo_mode_checkbox.setToolTip(self.tr("Send a couple of requests to each backend and keep the first valid answer."))
            self.order_group.set_title(self.tr("NAME ORDER"))
            self.party_order_label.setText(self.tr("Party order:"))
            self.party_order_combo.setItemText(0, self.tr("Defendants first"))
            self.party_order_combo.setItemText(1, self.tr("Plaintiffs first"))
            self.template_group.set_title(self.tr("FILENAME TEMPLATE"))
            self.add_element_label.setText(self.tr("Add element:"))
            self.template_selector.setItemText(0, self.tr("Date (today)"))
            self.template_selector.setItemText(1, self.tr("Plaintiff"))
            self.template_selector.setItemText(2, self.tr("Defendant"))
            self.template_selector.setItemText(3, self.tr("Letter type"))
            self.template_selector.setItemText(4, self.tr("Case number"))
            self.custom_name_edit.setPlaceholderText(self.tr("Custom element key (e.g., reference)"))
            self.custom_desc_edit.setPlaceholderText(self.tr("AI guidance for this element"))
            self.distribution_group.set_title(self.tr("DISTRIBUTION SETTINGS"))
            self.auto_threshold_label.setText(self.tr("Auto threshold (score):"))
            self.gap_threshold_label.setText(self.tr("Gap threshold (score):"))
            self.ai_confidence_label.setText(self.tr("AI confidence threshold:"))
            self.topk_label.setText(self.tr("Top-K candidates:"))
            self.unmatched_label.setText(self.tr("Handle UNMATCHED files:"))
            self.distribution_unmatched_combo.setItemText(0, self.tr("Leave in place"))
            self.distribution_unmatched_combo.setItemText(1, self.tr("Copy to UNASSIGNED subfolder"))
            self.distribution_unmatched_combo.setItemText(2, self.tr("Move to UNASSIGNED subfolder (destructive)"))
            self.distribution_unmatched_combo.setToolTip(self.tr("COPY keeps originals. MOVE removes originals from the input folder."))
            self.distribution_unassigned_ask_checkbox.setText(self.tr("Send ASK to UNASSIGNED too"))
            self.distribution_unassigned_ask_checkbox.setToolTip(self.tr("When enabled, ASK files without manual selection are sent to UNASSIGNED."))
            self.dest_exists_label.setText(self.tr("If destination exists:"))
            self.distribution_dest_exists_combo.setItemText(0, self.tr("Skip (default)"))
            self.distribution_dest_exists_combo.setItemText(1, self.tr("Rename copy"))
            self.distribution_dest_exists_combo.setItemText(2, self.tr("Overwrite (danger)"))
            self.distribution_dest_exists_combo.setToolTip(self.tr("Skip leaves existing files in place. Rename copy adds a counter. Overwrite replaces files."))
            self.stopwords_label.setText(self.tr("Stopwords (comma-separated):"))
            self.distribution_stopwords_edit.setPlaceholderText(self.tr("sp, spółka, sa, s.a, ag, z.o.o, oddzial, bank, international"))
            self.mode_group.set_title(self.tr("MODE"))
            self.copy_mode_checkbox.setText(self.tr("Copy files (default, mandatory)"))
            self.allow_home_case_root_checkbox.setText(self.tr("Allow case root under home folder"))
            self.allow_home_case_root_checkbox.setToolTip(self.tr("Unchecked = extra safety guard. Check only if you want to use a case root inside your home folder."))
            self.auto_apply_checkbox.setText(self.tr("Auto apply high-confidence only"))
            self.auto_apply_checkbox.setToolTip(self.tr("Apply only AUTO/AI items that meet confidence thresholds."))
            self.distribution_apply_during_planning_checkbox.setText(self.tr("Apply AUTO matches during planning (fast workflow)"))
            self.distribution_apply_during_planning_checkbox.setToolTip(self.tr("When enabled, AUTO matches are copied immediately while the plan is built."))
            self.distribution_use_ai_tiebreaker_checkbox.setText(self.tr("Use AI tie-breaker for ambiguous matches"))
            self.distribution_use_ai_tiebreaker_checkbox.setToolTip(self.tr("When enabled, AI can pick between close folder matches."))
            self.distribution_fast_mode_checkbox.setText(self.tr("Fast mode (recommended)"))
            self.distribution_fast_mode_checkbox.setToolTip(self.tr("Uses smaller candidate pools and skips expensive similarity work when no pair match."))
            self.unresolved_group.set_title(self.tr("UNRESOLVED HANDLING"))
            self.distribution_create_unresolved_checkbox.setText(self.tr("Create new folder for unresolved files"))
            self.distribution_create_unresolved_checkbox.setToolTip(self.tr("When enabled, unresolved files can be routed into newly created case folders."))
            self.unresolved_scope_label.setText(self.tr("Create folder for:"))
            self.distribution_create_unresolved_scope_combo.setItemText(0, self.tr("UNMATCHED only"))
            self.distribution_create_unresolved_scope_combo.setItemText(1, self.tr("UNMATCHED + unresolved ASK"))
            self.distribution_create_unresolved_case_checkbox.setText(self.tr("Include case number/tag in created folder name"))
            self.distribution_create_unresolved_dry_run_checkbox.setText(self.tr("Dry-run folder creation (log only)"))
            self.dist_paths_group.set_title(self.tr("DISTRIBUTION PATHS"))
            self.distribution_input_label.setText(self.tr("Folder containing PDFs to distribute:"))
            self.case_root_label.setText(self.tr("Case folders root:"))
            self.distribution_input_button.setText(self.tr("Browse"))
            self.case_root_button.setText(self.tr("Browse"))
            self.dist_controls_group.set_title(self.tr("EXECUTION"))
            self.distribute_button.setText(self.tr("RUN DRY RUN"))
            self.apply_distribution_button.setText(self.tr("APPLY PLAN"))
            self.pause_distribution_button.setText(self.tr("PAUSE"))
            self.plan_group.set_title(self.tr("DISTRIBUTION PLAN"))
            self.plan_show_label.setText(self.tr("Show:"))
            self.plan_sort_label.setText(self.tr("Sort:"))
            self.distribution_filter_combo.setItemText(0, self.tr("All"))
            self.distribution_filter_combo.setItemText(1, self.tr("ASK only"))
            self.distribution_filter_combo.setItemText(2, self.tr("AUTO only"))
            self.distribution_filter_combo.setItemText(3, self.tr("AI only"))
            self.distribution_filter_combo.setItemText(4, self.tr("UNMATCHED only"))
            self.distribution_filter_combo.setItemText(5, self.tr("Unresolved (ASK+UNMATCHED)"))
            self.distribution_sort_combo.setItemText(0, self.tr("Decision (ASK first)"))
            self.distribution_sort_combo.setItemText(1, self.tr("Confidence (low→high)"))
            self.distribution_sort_combo.setItemText(2, self.tr("Confidence (high→low)"))
            self.distribution_unresolved_workset_button.setText(self.tr("Create work set from unresolved"))
            self.distribution_show_unresolved_button.setText(self.tr("Show unresolved only"))
        if hasattr(self, "btn_lang_pl"):
            self.btn_lang_pl.setToolTip(self.tr("Polski"))
            self.btn_lang_en.setToolTip(self.tr("English"))
            self.btn_lang_pl.setAccessibleName(self.tr("Polski"))
            self.btn_lang_en.setAccessibleName(self.tr("English"))
